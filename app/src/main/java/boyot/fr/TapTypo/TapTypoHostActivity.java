 ...
 */
public class TapTypoHostActivity extends SimpleBaseGameActivity implements
    ...
    protected void onCreateResources() {
        ...
        // Recup la liste des paires avec intent
        // Lance le thread en lui donnnant la liste des paires et la liste des mots
        // Fait un read en attendant la liste des mots (moyen d'opti car on a deja la liste)
        // Le thread transmet la liste de mot aux paires ainsi qu'a l'hebergeur  (moyen d'opti car on a deja la liste)
        // Commence son jeu
        // Fin du jeu, envoi du score au thread
        // Fait un read en attendant le tableau des scores
        // Change d'activity en passant en intent le tableau des scores
